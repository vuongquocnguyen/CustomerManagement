...
$sql = "SELECT * FROM `customers`, `objecttype` group BY `customers`.`status` DESC,`customers`.`customer_id` ASC" ;
//$sql_l = "SELECT 'dt_ten' FROM 'objecttype' ";
                    ...
                    <table class="table table-bordered mt-1 align-middle" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody class="thead-light">
                            <?php foreach ($result as $each) : ?>
                                <tr class="text-dark">
                                    <td class="text-primary"> <?php echo $each['customer_id']; ?></td>
                                    ...
                                    <td class="text-primary"> <?php echo $each['dt_ten']; ?></td>
                                    ...
                                    <?php if($_SESSION['lever'] == 1): ?>
                                        <?php if($each['status'] == 1){ ?>
                                            <td>
                                                <a class="btn btn-danger" href="update_status.php?id=<?php echo $each['customer_id']; ?>&status=0">Not Active</a>
                                            </td>
                                        <?php }else{ ?>
                                            <td>
                                                <a class="btn btn-info" href="update_status.php?id=<?php echo $each['customer_id']; ?>&status=1">Active</a>
                                            </td>
                                        <?php } ?>
                                    <?php endif ?>
                                </tr>
